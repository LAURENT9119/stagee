      ...
      <div className="flex flex-1">
        ...
        <main className="flex-1 p-6 bg-white">
          <div className="mb-6">
            <div className="flex items-center space-x-4 mb-4">
              <Avatar className="w-16 h-16">
                <AvatarFallback className="bg-gray-300 text-2xl">A</AvatarFallback>
              </Avatar>
              <div>
              ...
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-left text-sm font-medium text-gray-500">Statut f.</th>
          ...
          <div className="mt-6 bg-yellow-100 border border-yellow-300 rounded-lg p-4">
            ...
            <p className="text-yellow-700">Une nouvelle demande à été enregistré</p>
          </div>
        </main>
      </div>
